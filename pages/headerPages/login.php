    ...
    <main>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <!-- START PAGE -->
                            <li class="nav-item">
                                <a class="nav-link fw-bold" aria-current="page" href="./allProducts.php"> <i class="fa-brands fa-shopify"></i> All Products</a>
                            </li>
                            <!-- END PAGE -->

                            <!-- START PAGE -->
                            <li class="nav-item">
                                <a class="nav-link active fw-bold" href="./login.php"> <i class="fa-solid fa-right-to-bracket"></i> Account</a>
                            </li>
                            <!-- END PAGE -->
        ...
        <?php
            ...
            if(isset($_SESSION["emailSession"])){
                session_start();
                var_dump($_SESSION["emailSession"]);
                unset($_SESSION["emailSession"]);
            }
            if(isset($_SESSION["passwordSession"])){
                session_start();
                var_dump($_SESSION["passwordSession"]);
        ...
        <div class="container mt-5 mb-5">
            <div class="row">
                <div class="col-12 text-center d-flex justify-content-center">
                    <!-- START LOGIN FORM -->
                    <form action="../../php/components/handleLogin/handleLogin.php"  method="POST">
                        <div class="card-login-sign mt-5 text-center border border-1">
                            <a class="login"><i class="fa-solid fa-right-to-bracket"></i> Login</a>
                            <div class="inputBox-login-sign">
                                <?php
                                /* 
                                email session
                                */
                                ...
                                unset($_SESSION["emailSession"]);
                                ?>
                                <input type="text" name="emailInput" >  <!-- required="required" -->
                                <span class="user">Email</span>
                            </div>
                            <div class="inputBox-login-sign">
                                <input type="password" name="passwordInput"> <!-- required="required" -->
                                <span>Password</span>
                            </div>
                            <button class="enter" type="submit" name="buttonLoginSubmit" >Enter</button>
                        </div>
                    </form>
                    <!-- END LOGIN FORM -->
                </div>
